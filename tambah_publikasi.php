...
<body>
 ...
 <div class="container-fluid bg-light position-relative shadow">
  ...
  <div class="container mt-5">
    ...
    <a href="tampil_anggota.php" class="btn btn-primary">Kembali ke Daftar Kegiatan</a>
      ...
      <div class="col-8">
        <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="tanggalKegiatan" name="tanggalKegiatan" style="width: 120px" required>
          </div>
