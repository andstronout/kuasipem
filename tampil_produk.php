...
<html lang="en">
  <head>
      ...
      <title>Daftar Produk KUAS Insan Pembangunan</title>
    </head>
  <body>
    <!-- nav -->
    ...
    <div class="container mt-5">
      <h1>Daftar Produk KUAS Insan Pembangunan</h1>

      <a href="tambah_produk.php" class="btn btn-primary">Upload Produk</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="align-middle">
              <img src="img/<?= $p["gambar"]; ?>" height="50" class="rounded-circle">
            </td>
            <td class="align-middle">
              <a href="edit_produk.php?id=<?= $p["id"]; ?>" class="btn badge bg-warning">ubah</a>
              <a href="hapus_produk.php?id=<?= $p["id"]; ?>" class="btn badge bg-danger" onclick="return confirm('yakin?');">hapus</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
