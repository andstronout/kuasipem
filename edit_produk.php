      ...
      <div class="col-8">
        <form action="" method="post"  enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="namaProduk" name="namaProduk" required value="<?= $p["namaProduk"]; ?>">
          </div>

          <div class="mb-3">
            <label for="deskripsi" class="form-label">Deskripsi Prduk</label>
            <input type="textarea" class="form-control" id="deskripsi" name="deskripsi" required value="<?= $p["deskripsi"]; ?>">
          </div>
          <div class="mb-3">
